...
namespace ChronoQuest.Core.Infrastructure.Migrations
{
    ...
    [Migration("20250612120242_Add_ReviewMaterialParagraph")]
    partial class Add_ReviewMaterialParagraph
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChronoQuest.Core.Domain.Base.ReviewMaterial", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ReviewMaterial");
                });

            modelBuilder.Entity("ChronoQuest.Core.Domain.Base.ReviewMaterialParagraph", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ChronoQuest.Core.Domain.Base.ReviewMaterial", b =>
                {
                    b.HasOne("ChronoQuest.Core.Domain.Base.User", null)
                        .WithOne()
                        .HasForeignKey("ChronoQuest.Core.Domain.Base.ReviewMaterial", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
