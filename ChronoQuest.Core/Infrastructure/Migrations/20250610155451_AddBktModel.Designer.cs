...
namespace ChronoQuest.Core.Infrastructure.Migrations
{
    ...
    [Migration("20250610155451_AddBktModel")]
    partial class AddBktModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChronoQuest.Core.Domain.AdaptiveLearning.BayesianKnowledgeTracingModel", b =>
                {
                    b.HasOne("ChronoQuest.Core.Domain.Base.Topic", null)
                        .WithMany()
                    ...
                    b.HasOne("ChronoQuest.Core.Domain.Base.User", null)
                        .WithOne()
                        .HasForeignKey("ChronoQuest.Core.Domain.AdaptiveLearning.BayesianKnowledgeTracingModel", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
